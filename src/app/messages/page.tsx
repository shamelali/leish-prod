              ...
              <>
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-neutral-800">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link href={`/artists/${active.artistId}`} className="p-2 text-gray-400 hover:text-rose-500 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-950/30"><Info className="w-4 h-4" /></Link>
                  </div>
                </div>
