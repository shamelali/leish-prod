    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-white dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-900">
        ...
        <div className="max-w-md mx-auto px-4 pt-32 pb-16 text-center">
          ...
          <Link href="/forgot-password" className="text-rose-600 dark:text-rose-400 font-medium hover:text-rose-700">
    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-white dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-900">
        ...
        <div className="max-w-md mx-auto px-4 pt-32 pb-16 text-center animate-scale-in">
          ...
          <Link href="/login" className="inline-flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-bold rounded-xl hover:from-rose-600 hover:to-pink-700 transition-all shadow-lg shadow-rose-200/50 dark:shadow-rose-900/30">
