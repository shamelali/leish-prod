  ...
  return (
    <main className="min-h-screen bg-gray-50/50 dark:bg-neutral-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Featured */}
        <Link href={`/${locale}/blog/${blogPosts[0].slug}`} className="group block mb-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {blogPosts.slice(1).map((post) => (
            <Link key={post.slug} href={`/${locale}/blog/${post.slug}`} className="group bg-white dark:bg-neutral-900 rounded-2xl overflow-hidden border border-gray-100 dark:border-neutral-800 shadow-sm hover:shadow-lg transition-all">
