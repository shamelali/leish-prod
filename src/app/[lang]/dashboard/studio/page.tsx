    ...
    <main className="min-h-screen bg-gray-50/50 dark:bg-neutral-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <Link href={`/${locale}/studios`} className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-rose-500 to-pink-600 text-white text-sm font-semibold rounded-xl shadow-lg shadow-rose-200/50 dark:shadow-rose-900/30 hover:from-rose-600 hover:to-pink-700 transition-all">
