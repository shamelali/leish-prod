...
export default function StudioDetailPage({ params: langParams }: Props) {
    ...
    return (
      <main className="min-h-screen bg-gray-50/50 dark:bg-neutral-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
          ...
          <Link href={`/${locale}/studios`} className="inline-flex items-center gap-2 px-6 py-3 bg-rose-500 text-white font-semibold rounded-xl hover:bg-rose-600 transition-colors">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-neutral-800">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {[...new Set(studio.categories)].map((cat, ci) => {
                  ...
                  return (
                    <Link key={`${cat}-${ci}`} href={`/${locale}/artists?category=${cat}`} className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-rose-50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400 rounded-full capitalize hover:bg-rose-100 dark:hover:bg-rose-950/70 transition-colors">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-neutral-800">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {studioArtists.map((artist) => (
                  <Link key={artist.id} href={`/${locale}/artists/${artist.id}`} className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-neutral-800 rounded-xl hover:bg-rose-50/50 dark:hover:bg-rose-950/20 transition-colors group">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-800 shadow-sm p-6">
                ...
                <Link href={`/${locale}/artists`} className="w-full py-3.5 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-bold rounded-xl hover:from-rose-600 hover:to-pink-700 transition-all shadow-lg shadow-rose-200/50 dark:shadow-rose-900/30 flex items-center justify-center gap-2">
