  ...
  return (
    <main className="min-h-screen bg-gray-50/50 dark:bg-neutral-950">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        {/* Back */}
        <Link href="/blog" className="inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-rose-600 dark:hover:text-rose-400 transition-colors mb-6">
        ...
        <div className="mt-10 p-5 bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-800 flex items-center gap-4">
          ...
          <Link href="/artists" className="ml-auto text-xs font-medium text-rose-500 hover:text-rose-600">View Profile →</Link>
        </div>
