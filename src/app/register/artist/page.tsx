      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 py-20">
        <div className="w-full max-w-2xl">
          ...
          <div className="grid grid-cols-3 gap-2 mb-6 animate-fade-in-up delay-75">
            ...
            <Link href="/register/studio" className="flex flex-col items-center gap-1.5 px-2 py-3 bg-white dark:bg-neutral-800 border-2 border-gray-100 dark:border-neutral-700 hover:border-indigo-300 dark:hover:border-indigo-700 rounded-xl text-center transition-all">
