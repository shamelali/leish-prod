      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-xl transition-colors shadow-sm"
            >
              ...
              {categories.slice(0, 4).map((cat) => (
                <li key={cat.id}>
                  ...
                  >
                    ...
                    {(t.categories as Record<string, any>)[cat.id] ?? cat.name}
                  </Link>
                </li>
              ))}
            </ul>
        ...
        <div className="mt-14 pt-8 border-t border-gray-800/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Leish! {t.footer.rights}
          </p>
