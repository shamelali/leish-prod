...
function withCloudinaryTransform(src: string, width?: number, height?: number, aspectRatio?: string): string {
  if (!CLOUD_NAME || !isCloudinaryUrl(src) || src.includes('/upload/') && !src.split('/upload/')[1].includes(',')) {
