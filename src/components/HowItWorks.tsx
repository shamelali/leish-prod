...
export default function HowItWorks({
  ...
  const steps = [
    { num: "01", icon: Search, title: t.howItWorks.step1Title, description: t.howItWorks.step1Desc, color: "#e11d48", bgColor: "bg-rose-50 dark:bg-rose-950/30" },
    { num: "02", icon: CalendarCheck, title: t.howItWorks.step2Title, description: t.howItWorks.step2Desc, color: "#db2777", bgColor: "bg-pink-50 dark:bg-pink-950/30" },
    { num: "03", icon: Sparkles, title: t.howItWorks.step3Title, description: t.howItWorks.step3Desc, color: "#8b5cf6", bgColor: "bg-purple-50 dark:bg-purple-950/30" },
  ];
    ...
    <section className="py-24 bg-gradient-to-b from-white to-rose-50/30 dark:from-neutral-950 dark:to-neutral-900" id="how-it-works">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-gray-900 dark:text-white">{t.howItWorks.title}</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-4 max-w-xl mx-auto">{t.howItWorks.subtitle}</p>
        </div>
