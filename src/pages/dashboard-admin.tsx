...
export default function DashboardAdmin() {
  ...
  const recentActivity = [
    {
      action: "New artist verified",
      detail: "Priya Kaur - Bridal MUA",
      time: "30 min ago",
      type: "artist",
    },
    {
      action: "Payout processed",
      detail: "RM 2,400 - Aiko Nakamura",
      time: "2 hours ago",
      type: "payment",
    },
    {
      action: "Booking completed",
      detail: "Bridal Package - RM 800",
      time: "3 hours ago",
      type: "booking",
    },
    {
      action: "New user registered",
      detail: "Sarah L. - Kuala Lumpur",
      time: "5 hours ago",
      type: "user",
    },
    {
      action: "Studio application",
      detail: "GlamHouse Studio - Penang",
      time: "1 day ago",
      type: "studio",
    },
    {
      action: "Payment dispute",
      detail: "Booking #1024 - RM 350",
      time: "2 days ago",
      type: "flag",
    },
  ];
  ...
  const filterBySearch = <
    T extends { name?: string; id?: string; email?: string },
  >(
    items: T[],
  ): T[] => {
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {[
                ...
                },
                {
                  icon: DollarSign,
                  label: "Total Revenue",
                  value: stats ? `MYR ${stats.revenue.toLocaleString()}` : "—",
                  sub: stats
                ...
                },
                {
                  ...
                  value: stats
                    ...
                    : "—",
                  sub: `${Math.ceil((stats?.pendingPayouts || 0) / 350)} payouts`,
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-neutral-800">
              <tr>
                ...
                <th className="text-right p-3 font-semibold text-gray-600 dark:text-gray-300">
                  Actions
                </th>
              </tr>
            </thead>
                ...
                filterBySearch(artists).map((artist) => (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <button
                        onClick={() =>
                          toggleVerify(artist.id, !artist.verified)
                        }
                    ...
                    <td className="p-3 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <a
                          ...
                          target="_blank"
                          className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
                        >
              ...
              {loading ? (
                ...
                filterBySearch(studios).map((studio) => (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <span className="text-amber-500">{studio.rating}</span>
                    </td>
              ...
              {loading ? (
                ...
                filterBySearch(payments).map((p) => (
                  ...
                  >
                    ...
                    <td className="p-3 font-mono text-xs text-gray-500">
                      {(p.bookingId || "").toString().slice(0, 8) || "—"}
                    </td>
                    <td className="p-3 font-medium text-gray-900 dark:text-white">
                      MYR {p.amount}
                    </td>
...
function PaymentBadge({ status }: { status: string }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${styles[status] || "bg-gray-100 text-gray-600 dark:bg-neutral-800"}`}
    >
      {status}
    </span>
  );
