      ...
      <div className="p-6 bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-800 mb-8">
        ...
        {showBankForm && (
          <form
            ...
            className="mb-6 p-4 bg-gray-50 dark:bg-neutral-800 rounded-xl space-y-3"
          >
            <input
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 dark:border-neutral-800">
                <th className="text-left px-5 py-3 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">
                  Client
                </th>
                <th className="text-left px-5 py-3 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase">
                  Service
                    ...
                    <td className="px-5 py-3">
                      {(() => {
                        switch (b.status) {
                          ...
                          case "completed":
                            return (
                              <span className="px-2 py-0.5 text-[10px] font-semibold bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-400 rounded-full">
                                Completed
                              </span>
                            );
                          case "cancelled":
                            return (
                              <span className="px-2 py-0.5 text-[10px] font-semibold bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 rounded-full">
                                Cancelled
                              </span>
                            );
                          default:
                            return (
                              <span className="px-2 py-0.5 text-[10px] font-semibold bg-gray-100 text-gray-600 dark:bg-neutral-700 rounded-full">
                                {b.status}
                              </span>
                            );
                        }
                      ...
                      {b.status === "pending" && (
                        <>
                          <button
                            ...
                            className="text-xs font-medium text-green-600 dark:text-green-400 hover:text-green-700 mr-2"
                          >
        ...
        {totalPages > 1 && (
          <div className="px-5 py-4 border-t border-gray-100 dark:border-neutral-800 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={() =>
                  setBookingsPage((p) => Math.min(totalPages, p + 1))
                }
